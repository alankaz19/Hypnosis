...
public class LevelOneScene extends GameState {
    ...
    public void init() {
        ...
        if (!SECRET) {
            ...
            handler.addObject(new Paint(120, 280, ObjectID.PICTURE, Texture.getInstance().secretThumbnail[0], 0));
            handler.addObject(new Paint(440, 280, ObjectID.PICTURE, Texture.getInstance().secretThumbnail[1], 0));
            handler.addObject(new Paint(760, 280, ObjectID.PICTURE, Texture.getInstance().secretThumbnail[2], 0));
            handler.addObject(new Paint(1080, 280, ObjectID.PICTURE, Texture.getInstance().secretThumbnail[3], 0));
        }
